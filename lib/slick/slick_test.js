...
*/
	...
	$('.slider-nav').slick({
	 ...
	 /*  nextArrow: "<h1><span class='glyphicon glyphicon-chevron-right white'></span></h1>",*/
		...
		prevArrow:'<a target="_blank" id="buttonFirstPage"><span class="fa fa-chevron-left fa-4x" style="margin-left: 0px;"><span class="fa fa-chevron-left" style="margin-left: -15px;"></a><a class="slick-prev"><span class="glyphicon glyphicon-chevron-left"></span></a>',
		
		nextArrow:'<a class="slick-next"><span class="glyphicon glyphicon-chevron-right"></span></a><a target="_blank" id="buttonLastPage"><span class="fa fa-chevron-right fa-4x" style="margin-left: 0px;"><span class="fa fa-chevron-right" style="margin-left: -15px;"></a>',
